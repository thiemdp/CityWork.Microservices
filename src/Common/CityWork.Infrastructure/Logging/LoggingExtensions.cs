...
namespace CityWork.Infrastructure
{
    ...
    {
        private static void UseCityWorkLogger(this IWebHostEnvironment env, LoggingOptions options)
        {
        ...
        public static IWebHostBuilder UseCityWorkLogger(this IWebHostBuilder builder, Func<IConfiguration, LoggingOptions> logOptions)
        {
            builder.ConfigureLogging((context, logging) =>
            {
                ...
                context.HostingEnvironment.UseCityWorkLogger(options);
            });

            return builder;
        }

        public static IHostBuilder UseCityWorkLogger(this IHostBuilder builder, Func<IConfiguration, LoggingOptions> logOptions)
        {
            builder.ConfigureLogging((context, logging) =>
            {
                logging.Configure(options =>
        ...
        private static void UseCityWorkLogger(this IHostEnvironment env, LoggingOptions options)
        {
            var assemblyName = Assembly.GetEntryAssembly()?.GetName().Name;
